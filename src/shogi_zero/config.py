...
class ResourceConfig:
    ...
    def __init__(self):
        ...
        self.model_best_distributed_ftp_server = "alpha-shogi-zero.mygamesonline.org"
        self.model_best_distributed_ftp_user = "2537576_shogi"
        self.model_best_distributed_ftp_password = "alpha-shogi-zero-2"
        self.model_best_distributed_ftp_remote_path = "/alpha-shogi-zero.mygamesonline.org/"
...
def flipped_uci_labels():
    """
    Seems to somehow transform the labels used for describing the universal shogi interface format, putting
...
def create_uci_labels():
    """
    Creates the labels for the universal shogi interface into an array and returns them
    :return:
    """
    labels_array = []
...
class Config:
    ...
    def __init__(self, config_type="mini"):
        ...
        if config_type == "mini":
            import shogi_zero.configs.mini as c
        elif config_type == "normal":
            import shogi_zero.configs.normal as c
        elif config_type == "distributed":
            import shogi_zero.configs.distributed as c
        else:
